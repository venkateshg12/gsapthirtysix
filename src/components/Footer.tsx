...
const Footer = () => {
    return (
        <div>
            <div className='w-full min-h-[1rem]  mt-[10rem] 2xl:mt-[20rem] '>
                ...
                <div className='flex items-center flex-col md:flex-row justify-center mb-[1rem] gap-[3rem] md:gap-[20rem]'>
